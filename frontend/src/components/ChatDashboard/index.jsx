        ...
        <div className={styles.msgArea}>
          ...
          <div className={styles.messages}>
            ...
            <div className={`${styles.msgBox} ${styles.incomingMsg}`}>
              ...
              jaayenge Toh khud se hi ho jaayenge judaa Kyunki tum hi ho Ab tum
              hi ho Zindagi ab tum hi ho Chain bhi, mera dard bhi Meri aashiqui
              ab tum hi ho Read more at:
              https://www.highclap.com/tum-hi-ho-lyrics-aashiqui-2-arijit-singh/{" "}
              <Time />
            </div>
            <div className={`${styles.msgBox} ${styles.outgoingMsg}`}>
              Tera mera rishta hai kaisa Ik pal door gawara nahi Tere liye har
              roz hai jeete Tujh ko diya mera waqt sabhi Koi lamha mera na ho
              tere bina Har saans pe naam tera Kyunki tum hi ho Ab tum hi ho
              Zindagi ab tum hi ho Chain bhi, mera dard bhi Meri aashiqui ab tum
              hi ho Read more at:
              https://www.highclap.com/tum-hi-ho-lyrics-aashiqui-2-arijit-singh/{" "}
              <Time />
            </div>
