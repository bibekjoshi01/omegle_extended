...
urlpatterns = [
    ...
    path('status/<str:room_id>', CheckChatStatusAPIView.as_view(), name='check_chat_status'),
    ...
    path('disconnect/<str:room_id>', DisconnectChatAPIView.as_view(), name='disconnect_chat'),
]
